...
안전 단계와 1분 예측은 가장 밀도가 높은 고정 그리드 셀을 사용합니다. 이동 영역의
...
예측 시점은 1분 뒤입니다. 약 3분 길이의 보유 영상 안에서 과거 관측 구간과 미래
정답 구간을 함께 확보하기 위해 최근 최대 2분을 사용하며, 최소 30초가 쌓인 뒤
5초마다 새로운 1분 뒤 예측을 생성합니다.

현재 런타임은 시작 후 첫 30초 동안 현재값 유지 기준선을 사용하고, 이후 최근 최대
2분을 5초 단위 중앙값 버킷으로 구성해 감쇠 선형 추세를 적용합니다. 준비 상태와
신뢰도를 함께 제공하지만,
